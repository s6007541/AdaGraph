...
parser.add_argument('--finetune', type=int, default=0, help='whether to finetune the model') # TTA needs to work here
...
parser.add_argument('--bn_momentum', type=float, default=0.4)
parser.add_argument('--use_learned_stats', type=int, default=1)
parser.add_argument('--conf_filter', type=float, default=None)
parser.add_argument('--ent_filter', type=float, default=10.0)
parser.add_argument('--ep_tta', type=int, default=1)
parser.add_argument('--lr_tta', type=float, default=0.01)
parser.add_argument('--sam', action='store_true')
parser.add_argument('--train_all', action='store_true')
parser.add_argument('--not_reset', action='store_true')
